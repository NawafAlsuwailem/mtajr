...
<div class="container">
    <h3 style="text-align: center">ÂÕ«Â’ «‰‚ÁË… Ë√œË« Á«</h3>
    <div class="grid-container">
        <c:forEach var="tempStore" items="${roaster_stores}">
            <div class="grid-item">
                <c:url var="loadImage" value="/store/loadImage">
                    <c:param name="id" value="${tempStore.id}"/>
                </c:url>
                <img src="${loadImage}" style="width:auto;max-width:20%; align-content: center"/>
                <p>
                        ${tempStore.name}
                </p>
            </div>
