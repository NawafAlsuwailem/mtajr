...
<div class="container header">
    ...
    <div class="col-lg-11 col-xs-9">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a href="${pageContext.request.contextPath}/store/roasters" >ÂÕ«Â’ «‰‚ÁË… Ë«œË« Á«</a>
            <a href="${pageContext.request.contextPath}/store/tools" >Â «Ã—  ÃÂÍŸ «‰‚ÁË… Ë«œË« Á«</a>


            <c:if test="${not empty pageContext.request.userPrincipal}">
                <if:out value="${param.logout}">
                    <a id="admin-option" href="${pageContext.request.contextPath}/admin/list" class="active">‚«∆Â… «‰Â «Ã—</a>
